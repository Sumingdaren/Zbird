...
define(["jquery", "cookie"], function($) {
	...
	car.prototype = {
		...
		bind: function() {
			// 跳转购物车页面
			// window.location.href = 'http://localhost:81/dist/shopping.html';
			window.location.href = 'https://sumingdaren.github.io/emmm/dist/shopping.html';
		},
		jp: function() {
			// 跳转列表页
			// window.location.href = 'http://localhost:81/dist/list.html';
			window.location.href = 'https://sumingdaren.github.io/emmm/dist/list.html';
		},
		jp2: function() {
			// 首页跳转主页
			// window.location.href = 'http://localhost:81/dist/index.html';
			window.location.href = 'https://sumingdaren.github.io/emmm/dist/index.html';
		},
		lo : function(){
			// LOGO跳转主页
			// window.location.href = 'http://localhost:81/dist/index.html';
		...
		mmp : function(){
			...
			window.location.href = 'https://sumingdaren.github.io/emmm/dist/sign.html';
		},
		mmm : function(){
			// 登录页
			window.location.href = 'http://localhost:81/dist/register.html';
			window.location.href = 'https://sumingdaren.github.io/emmm/dist/register.html';
		},
		hd : function(){
			// 活动页
			// window.location.href = 'http://localhost:81/dist/activit.html';
			window.location.href = 'https://sumingdaren.github.io/emmm/dist/activit.html';
		},
		ppp : function(){
			// 列表页
			// window.location.href = 'http://localhost:81/dist/list.html';
